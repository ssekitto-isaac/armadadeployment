    ...
    return (
      ...
      >
        ...
        >
          ...
          {/* Abstract 3D Geometric Shape in Background – Armada blue border */}
          <div className="absolute -right-4 -bottom-4 opacity-0 group-hover:opacity-10 transition-opacity duration-700">
            <div className="w-24 h-24 rounded-full border-[10px] border-[#142842]" />
          </div>
        </div>
      </motion.div>
    );
  ...
  const SupportVisual = () => (
    <div className="relative w-72 h-72 flex items-center justify-center">
      ...
      <motion.div
        ...
        className="relative z-10 w-28 h-28 bg-white rounded-[2.5rem] shadow-2xl border border-[#142842]/20 flex items-center justify-center group"
      >
        <MessageSquare className="w-12 h-12 text-[#142842] group-hover:scale-110 transition-transform duration-500" />
        <div className="absolute -top-1 -right-1 flex h-4 w-4">
          <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-[#91CD95]/75 opacity-75"></span>
          <span className="relative inline-flex rounded-full h-4 w-4 bg-[#91CD95] shadow-sm" />
        </div>
      </motion.div>
      ...
      {[0, 120, 240].map((rotation, i) => (
        ...
        >
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-7 h-7 bg-[#91CD95]/10 rounded-lg border border-[#91CD95]/20 flex items-center justify-center shadow-sm">
            <Zap className="w-3.5 h-3.5 text-[#91CD95]" />
          </div>
        </motion.div>
      ))}
      
      {/* Atmospheric Glow – Armada blue + green */}
      <div className="absolute inset-0 bg-gradient-to-tr from-[#142842]/10 to-[#91CD95]/10 rounded-full blur-[80px] -z-10" />
    </div>
  );
  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] font-sans text-slate-900 selection:bg-[#91CD95]/20 selection:text-[#142842]">
      ...
      <section className="relative pt-24 pb-16 overflow-hidden">
        <div className="container mx-auto px-6 relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div initial={{ opacity: 0, x: -25 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6 }}>
              ...
              <p className="text-lg text-slate-600 max-w-lg leading-relaxed antialiased">
        ...
        <div className="absolute top-0 right-0 w-1/2 h-full bg-gradient-to-l from-[#142842]/5 to-transparent -z-10" />
      </section>
      ...
      <section id="ContactForm" className="pb-32">
        <div className="container mx-auto px-6">
          <div className="grid lg:grid-cols-5 gap-12">
            ...
            {/* Form Container */}
            <div className="lg:col-span-3 bg-white rounded-[2.5rem] shadow-2xl shadow-[#142842]/5 p-8 md:p-14 border border-slate-100 relative overflow-hidden group">
              <div className="absolute top-0 right-0 w-64 h-64 bg-[#91CD95]/10 rounded-full blur-3xl -z-0 opacity-50 group-hover:opacity-100 transition-opacity duration-700" />
              ...
              <div className="relative z-10">
                ...
                {isSubmitted && (
                  <div className="mb-8 p-5 bg-[#91CD95] text-white rounded-2xl flex items-center gap-4 animate-in zoom-in duration-300">
                    <CheckCircle2 className="w-6 h-6" />
                    <div>
                      <p className="font-bold">Message Transmitted</p>
                      <p className="text-sm opacity-90 text-white/90">Reference #ARC-{Math.floor(Math.random() * 10000)} generated.</p>
                    </div>
                  </div>
                )}
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                  ...
                  <div className="space-y-2">
                    ...
                    <textarea
                      ...
                      className="w-full bg-slate-50 border-transparent border-b-2 border-b-slate-200 py-3 px-1 focus:outline-none focus:border-[#91CD95] focus:bg-white transition-all duration-300 resize-none"
                      required
                    />
                  </div>
